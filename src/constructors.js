...
//Make the Safe constructor take 2 arguments. The first argument can be any piece if data to keep safe.
...
//If the key matches the key that was used to create the Safe; then return the secret data.
function Key() {
